...
int play_level_2() {
	...
	while (1) { // main loop
		...
		if (rl_step_mode) {
			...
			control_shift = 0;
			switch (rl_action) {
			case 1:  control_x = 1; break;
			case 2:  control_x = -1; break;
			case 3:  control_y = -1; break;
			case 4:  control_y = 1; break;
			case 5:  control_shift = -1; break;
			case 6:  control_x = 1;  control_y = -1; break;
			case 7:  control_x = 1;  control_y = 1; break;
			case 8:  control_x = -1; control_y = -1; break;
			case 9:  control_x = -1; control_y = 1; break;
			case 10: control_x = 1;  control_shift = -1; break;
			case 11: control_x = -1; control_shift = -1; break;
			}
		}
